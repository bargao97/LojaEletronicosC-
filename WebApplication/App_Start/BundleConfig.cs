...
namespace WebApplication
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            RegisterJSPropios(bundles);
        }

        private static void RegisterDocumentation(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/CONTRATOS/jput/2").Include(
                "~/Scripts/CONTRATOS/jput-2.js"));
        }

        private static void RegisterJSPropios(BundleCollection bundles)
        {

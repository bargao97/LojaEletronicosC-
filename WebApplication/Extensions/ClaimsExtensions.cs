...
namespace WebApplication.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        static string GetTipoLogin(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WebApplication.Models.RegisterViewModel.TIPO_LOGIN")?.Value;
        }
    }
}